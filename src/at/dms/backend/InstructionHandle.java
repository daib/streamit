 ...
 *
 * $Id: InstructionHandle.java,v 1.1 2009/02/24 18:14:59 hormati Exp $
 */
...
public class InstructionHandle extends AbstractInstructionAccessor implements at.dms.classfile.Constants {
    ...
    public boolean hasReturnValue() {
        return insn.getPushedOnStack() > 0;
    }

    public int countOperands() {
        return insn.getPoppedFromStack();
    }

    public boolean isPop() {
        return insn.getOpcode() == opc_pop || insn.getOpcode() == opc_pop2;
    }

    public boolean isDup() {
        return insn.getOpcode() == opc_dup || insn.getOpcode() == opc_dup2;
    }
    public boolean isDupX2() {
        return insn.getOpcode() == opc_dup_x2 || insn.getOpcode() == opc_dup2_x2;
    }

    public boolean isSwap() {
        return insn.getOpcode() == opc_swap;
    }
