 ...
 *
 * $Id: JCompoundAssignmentExpression.java,v 1.1 2009/02/24 18:14:51 hormati Exp $
 */
...
public class JCompoundAssignmentExpression extends JAssignmentExpression {
    ...
    public <S,T> S accept(ExpressionVisitor<S,T> p, T o) {
        return p.visitCompoundAssignment(this,o);
    }
    ...
    protected void deepCloneInto(at.dms.kjc.JCompoundAssignmentExpression other) {
