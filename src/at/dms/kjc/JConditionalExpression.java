 ...
 *
 * $Id: JConditionalExpression.java,v 1.1 2009/02/24 18:14:51 hormati Exp $
 */
...
public class JConditionalExpression extends JExpression {
    ...
    public JExpression getCond() { return cond; }
    
    
    public JExpression getLeft() { return left; }
    public void setLeft(JExpression left) {
        this.left = left;
    }

    public JExpression getRight() { return right; }
    ...
    public <S,T> S accept(ExpressionVisitor<S,T> p, T o) {
        return p.visitConditional(this,o);
    }
