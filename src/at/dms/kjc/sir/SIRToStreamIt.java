 ...
 * @version $Id: SIRToStreamIt.java,v 1.1 2009/02/24 18:14:48 hormati Exp $
 */
    ...
    implements Constants, SLIRVisitor, AttributeStreamVisitor, CodeGenerator
{
    ...
    public static void run(SIRStream str,
	  ...
	  if (buffer!=null) buffer.append(s2s.getPrinter().getString());
        s2s.close();
    }
    ...
    public void visitForStatement(JForStatement self,
        ...
        // RMR { print semicolon to terminate loop in case 
        // body is empty
