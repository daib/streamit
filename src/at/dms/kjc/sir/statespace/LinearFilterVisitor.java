 ...
 *
 * $Id: LinearFilterVisitor.java,v 1.1 2009/02/24 18:14:53 hormati Exp $
    ...
    public void complete() {
        ...
        for(int i = 0; i < this.fieldSize; i++) {
            ...
            if (this.variablesToLinearForms.containsKey(fieldWrapper)) {
                ...
                fieldForm = this.variablesToLinearForms.get(fieldWrapper);
                rowVal = offset+i;
        ...
        //Finally, the last state (which is a constant) is always updated by itself, so place a one
        // in the last entry of the A matrix
        this.A.setElement(this.stateSize-1,this.stateSize-1,ComplexNumber.ONE);
