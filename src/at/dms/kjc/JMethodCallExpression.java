 ...
 *
 * $Id: JMethodCallExpression.java,v 1.1 2009/02/24 18:14:51 hormati Exp $
 */
...
public class JMethodCallExpression extends JExpression {
    ...
    public JMethodCallExpression(String ident,
                                 JExpression[] args) {
        this(null, ident, args);
    }
    ...
    public <S,T> S accept(ExpressionVisitor<S,T> p, T o) {
        return p.visitMethodCall(this,o);
    }
