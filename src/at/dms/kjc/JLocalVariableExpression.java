 ...
 *
 * $Id: JLocalVariableExpression.java,v 1.1 2009/02/24 18:14:51 hormati Exp $
 */
...
public class JLocalVariableExpression extends JExpression {
    ...
    public JLocalVariableExpression(JLocalVariable variable) { 
        this(null, variable);
    }
    ...
    public <S,T> S accept(ExpressionVisitor<S,T> p, T o) {
        return p.visitLocalVariable(this,o);
    }
