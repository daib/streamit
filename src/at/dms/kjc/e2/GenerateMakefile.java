// $Header: /n/tiamat/y/repository/StreamItNew/streams/src/at/dms/kjc/cluster/GenerateMakefile.java,v 1.1 2009/02/24 18:14:55 hormati Exp $
...
public class GenerateMakefile {
    ...
    */
    public static void generateMakefile(SIRHelper[] helpers) {
        ...
        p.newLine();    
        p.print("CXX = g++\n"); // gcc change this to powerpc for powerpc
        p.print("CCFLAGS = -m32 -O3\n");

        p.newline();
        p.println("# Unsupported target machines");
        p.print("CC_IA64 = ecc\n");
        p.print("CC_ARM = arm343 #arm-linux-gcc\n");
        p.print("CCFLAGS_IA64 = -m32 -O3\n");
        p.print("CCFLAGS_ARM = -m32 -O3\n");
