...
public class E2CodeEstimate extends SLIREmptyVisitor {
    ...
    /**
     * Creates a new instance of E2CodeEstimate and passes
     ...
     * @return instance of E2CodeEstimate with code and locals estimates
     */

    public static E2CodeEstimate estimate(SIRFilter filter) {
        E2CodeEstimate est = new E2CodeEstimate(filter);
    ...
    private E2CodeEstimate(SIRFilter filter) {
        this.filter = filter;
        code_size = 0;
        locals_size = 0;
