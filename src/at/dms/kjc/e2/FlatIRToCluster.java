...
//                new SIRGlobal[0]);
    ...
    public void visitFilter(SIRFilter self, SIRFilterIter iter) {
        ...
        if ((KjcOptions.mencoder || KjcOptions.blender) && ((self instanceof SIRFileReader) ||
        ...
        Integer init_int = E2Backend.initExecutionCounts
            .get(node);
        int init_counts;
        ...
        int steady_counts = E2Backend.steadyExecutionCounts
                             .get(node).intValue();
        ...
        E2CodeGenerator gen = new E2CodeGenerator(self, self
                                                            .getFields());
        ...
        p.print("void " + E2Utils.getWorkName(self, selfID)
                + "(int);\n\n");
...
//        }
        ...
        Vector run = 
            gen.generateRunFunction(filter.getInit().getName() + "__"
                                    + selfID, 
                                    E2Utils.getWorkName(filter, selfID),
                                    cleanupCode);
...
//        }
    ...
    private void pushArray(SIRPushExpression self, CType tapeType,
        ...
        if (outputTape instanceof E2TapeDynrate) {
            ...
            p.print("(reinterpret_cast<" + ((E2TapeDynrate)(outputTape)).getTypeCastName() + ">(&");
            val.accept(this);
            p.print("))");
        } else {
            p.print(outputTape.getPushName());
