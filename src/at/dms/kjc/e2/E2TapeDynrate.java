 ...
 *
 */
public class E2TapeDynrate extends TapeBase implements Tape {
    ...
    public E2TapeDynrate(int source, int dest, CType type) {
    ...
    public String dataDeclarationH() {
        ...
        if (KjcOptions.dynamicRatesEverywhere) {
            ...
            StaticStreamGraph ssg = E2Backend.streamGraph.parentMap
                    .get(srcnode);
